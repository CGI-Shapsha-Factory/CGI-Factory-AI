...
| 1 | `cadrage-extraction` | Matière brute -> `capture-brute.md` (contenu, sans horodatage ni src) + **passe découverte** (18 questions, interactif) -> `project-frame.md` | manifeste existe + une source déclarée |
...
- **Découverte cadrée.** `cadrage-extraction` couvre 18 questions de cadrage
