...
description: Accompagne le PO pour créer dans Linear une évolution de recette complète, portant une proposition de mise à jour de la spécification précise et circonscrite, rattachée au ticket Feature.
---
...
`references/regles-recette.md`). Son rôle : garantir qu'une évolution naît complète, bien
...
- **Terrain de recette posé** : le bloc `recette` du manifeste et le gabarit
  `.factory/recette/gabarit-evolution.md` existent. Sinon, proposer en clair de lancer d'abord
  `/recette:recette-init`.
...
2. **Compléter le gabarit, section par section** (`.factory/recette/gabarit-evolution.md`),
   ...
   - la **proposition de mise à jour de la spécification**. C'est la section clé : **lire
     ...
     discipline chirurgicale, cf. `references/regles-recette.md`).
...
Étape suivante : `/recette:realisation-evolution` - quand un développeur prend l'évolution en charge.
