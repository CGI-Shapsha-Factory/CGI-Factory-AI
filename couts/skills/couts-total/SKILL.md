---
name: couts-total
description: Agrège toutes les sessions locales en un seul fichier de bilan partageable (total tokens, coût estimé, nombre de sessions) pour le chef d'équipe.
---
