...
À l'**Étape 10** de `architecte-contrat`, le sous-dossier correspondant à la stack retenue est copié à la racine du projet généré, puis les placeholders sont remplis depuis `stack-technique.md`, `composants.md` et les ADR.
