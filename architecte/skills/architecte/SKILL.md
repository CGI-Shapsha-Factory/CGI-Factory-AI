...
`cadrage-out/` : `project-frame.md` (Q1–Q13 + *seeds qualité* Q2/Q6/Q7),
`product-brief.md`, `glossaire.md`, `spec-index.md` (use cases + walking skeleton
candidat + couverture), les briefs sous `cadrage-out/features-fonctionnels-brief/*.brief.md`.
Conventions
...
valider, puis écrire `architecte-out/drivers-quality.md` (gabarit
...
validation**. Puis écrire `architecte-out/components.md` (gabarit
