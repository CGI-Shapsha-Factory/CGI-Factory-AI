...
`diagrams.md`, `risks.md` ; le dossier `conventions/` ; les briefs `*.brief.md` ;
le manifeste.
...
il échoue si une réponse bloquante manque ou si un langage retenu n'a pas son fichier
de conventions.
...
découpages), le registre de risques. (L'assembleur coud ensuite ces contrats par
feature, une fois le contrat de design figé.)
