...
**Cas particulier du prompt Claude Design** : le corps du prompt est du plein texte sans Markdown ; il suit aussi cette règle (pas de tiret cadratin, pas de guillemets à chevrons).
