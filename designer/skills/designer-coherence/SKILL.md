...
- **Trou structurel dans l'export** (parcours sans écran, entité non affichable, état/écran absent, thème
  ...
  le système) : le **renvoyer vers Claude Design** — réamorcer le prompt via `/designer:designer-atelier` si
  la **couverture** elle-même était fausse, ou faire **redéposer un export corrigé** dans
