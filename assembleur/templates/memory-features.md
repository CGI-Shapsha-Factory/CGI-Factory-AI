...
|---------|--------|------------------|-----------|
| 001 — [intitulé] | `assembleur-out/features/001-…spec-seed.md` | oui | — |
| 002 — [intitulé] | `assembleur-out/features/002-…spec-seed.md` | non | 001 |

## Couplage
[Renvoi à `assembleur-out/feature-map.md` : états partagés et dépendances entre features.]

## Les 3 faces (par feature)
- **Fonctionnelle** : la graine `assembleur-out/features/<id>-…spec-seed.md` — User Scenarios + FR.
